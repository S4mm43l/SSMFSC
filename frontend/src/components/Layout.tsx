      ...
      <header className="sticky top-0 z-50">
        <div className="bg-linear-to-r from-[#1043b3] to-[#1455e2] text-white border-b border-white/20 shadow-lg">
          <nav className="mx-auto max-w-6xl px-6 py-5 flex items-center justify-between gap-6">
            <a
              href={language === "sk" ? "https://www.tuke.sk/sk" : "https://www.tuke.sk/en"}
              target="_blank"
        ...
        {location.pathname === '/' && (
          <div className="bg-white/95 backdrop-blur-sm border-b border-gray-200 py-3 shadow-sm">
            <div className="mx-auto max-w-6xl px-6 flex flex-wrap justify-center items-center gap-6 md:gap-10">
              ...
              >
                <img
                  src="/logo/logo-nextgen.png"
                  alt="NextGenerationEU"
                  className="h-10 md:h-14 w-auto object-contain cursor-pointer"
                />
              </a>

              {/* Plán obnovy (len SK verzia existuje) */}
              <a
                href="https://www.planobnovy.sk/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="/logo/POO_logo_modre-1024x500.png"
                  alt="Plan Obnovy"
                  className="h-10 md:h-14 w-auto object-contain cursor-pointer"
                />
              </a>
              ...
              <a
                href={language === "sk"
                  ...
                  : "https://vaia.gov.sk/en/"}
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="/logo/Verzia-loga-s-popiskom_Verzia-loga-s-popiskom-Farebne-prevedenie-1-2.png"
                  alt="VAIA"
                  className="h-10 md:h-14 w-auto object-contain cursor-pointer"
                />
              </a>

              {/* Výskumná agentúra – má SK aj EN */}
              <a
                href={language === "sk"
                  ? "https://www.vyskumnaagentura.sk/sk/"
                  : "https://www.vyskumnaagentura.sk/en/"}
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="/logo/logo-ved-ag.png"
                  alt="Vyskumna agentura"
                  className="h-10 md:h-14 w-auto object-contain cursor-pointer"
                />
              </a>
