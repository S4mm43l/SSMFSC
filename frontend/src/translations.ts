export const translations = {
  sk: {
    ...
    follow_label_coord: "Zodpovedný riešiteľ projektu",
    ...
    downloadBtn: "Stiahnuť údaje (.csv)",
        // Data – Charts
    charts_title: "Vizualizácia meteorologických údajov",

    avg_temp: "Priemerná teplota",
    avg_wind: "Priemerná rýchlosť vetra",

    chart_temp: "Vývoj teploty počas dňa",
    chart_vis: "Vývoj viditeľnosti počas dňa",
    chart_wind: "Vývoj rýchlosti vetra počas dňa",

    data_location: "Lokalita",
    data_metrics: "Metriky",
    data_all_locations: "Všetky",
    data_no_data_for_date: "Pre zvolený dátum nie sú dostupné žiadne údaje.",

    group_weather: "Poveternostné podmienky",
    group_rain_wind: "Dážď a vietor",
    group_signal_particles: "Signál a častice",

    metric_temp: "Teplota (°C)",
    metric_humidity: "Vlhkosť (%)",
    metric_pressure: "Tlak (hPa)",
    metric_rain: "Dážď (mm/h)",
    metric_wind: "Rýchlosť vetra (km/h)",
    metric_dust: "Prach/Hmla",
    metric_rssi: "RSSI (dBm)",
  ...
  en: {
    ...
    // Data – Charts
    charts_title: "Meteorological data visualisation",

    avg_temp: "Average temperature",
    avg_wind: "Average wind speed",

    chart_temp: "Temperature variation during the day",
    chart_vis: "Visibility variation during the day",
    chart_wind: "Wind speed variation during the day",

    data_location: "Location",
    data_metrics: "Metrics",
    data_all_locations: "All",
    data_no_data_for_date: "No data for selected date.",

    group_weather: "Weather conditions",
    group_rain_wind: "Rain and wind",
    group_signal_particles: "Signal and particles",

    metric_temp: "Temperature (°C)",
    metric_humidity: "Humidity (%)",
    metric_pressure: "Pressure (hPa)",
    metric_rain: "Rain (mm/h)",
    metric_wind: "Wind speed (km/h)",
    metric_dust: "Dust/Fog",
    metric_rssi: "RSSI (dBm)",
